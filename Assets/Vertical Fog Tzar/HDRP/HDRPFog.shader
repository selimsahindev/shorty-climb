Shader "Tzar/HDRP Fog"
{
    Properties
    {
        _FogIntensity("Intensity", Float) = 1
        _ColorOfFog("Color", Color) = (0, 0, 0, 1)
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        float4 _Property_56A9789A_Out_0 = _ColorOfFog;
                        float _Split_8B0C9F7B_R_1 = _Property_56A9789A_Out_0[0];
                        float _Split_8B0C9F7B_G_2 = _Property_56A9789A_Out_0[1];
                        float _Split_8B0C9F7B_B_3 = _Property_56A9789A_Out_0[2];
                        float _Split_8B0C9F7B_A_4 = _Property_56A9789A_Out_0[3];
                        float _SceneDepth_3A0701D6_Out_1;
                        Unity_SceneDepth_Eye_float(float4(IN.ScreenPosition.xy / IN.ScreenPosition.w, 0, 0), _SceneDepth_3A0701D6_Out_1);
                        float4 _ScreenPosition_BEA42E77_Out_0 = IN.ScreenPosition;
                        float _Split_4A895B39_R_1 = _ScreenPosition_BEA42E77_Out_0[0];
                        float _Split_4A895B39_G_2 = _ScreenPosition_BEA42E77_Out_0[1];
                        float _Split_4A895B39_B_3 = _ScreenPosition_BEA42E77_Out_0[2];
                        float _Split_4A895B39_A_4 = _ScreenPosition_BEA42E77_Out_0[3];
                        float _Subtract_80135282_Out_2;
                        Unity_Subtract_float(_SceneDepth_3A0701D6_Out_1, _Split_4A895B39_A_4, _Subtract_80135282_Out_2);
                        float _Property_36DA2C52_Out_0 = _FogIntensity;
                        float _Multiply_89442927_Out_2;
                        Unity_Multiply_float(_Subtract_80135282_Out_2, _Property_36DA2C52_Out_0, _Multiply_89442927_Out_2);
                        float _Saturate_2636E134_Out_1;
                        Unity_Saturate_float(_Multiply_89442927_Out_2, _Saturate_2636E134_Out_1);
                        float _Multiply_D568CE91_Out_2;
                        Unity_Multiply_float(_Split_8B0C9F7B_A_4, _Saturate_2636E134_Out_1, _Multiply_D568CE91_Out_2);
                        surface.Alpha = _Multiply_D568CE91_Out_2;
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        float _Multiply_D568CE91_Out_2;
                        Unity_Multiply_float(_Split_8B0C9F7B_A_4, _Saturate_2636E134_Out_1, _Multiply_D568CE91_Out_2);
                        surface.Color = (_Property_56A9789A_Out_0.xyz);
                        surface.Alpha = _Multiply_D568CE91_Out_2;
                        surface.AlphaClipThreshold = 0;
